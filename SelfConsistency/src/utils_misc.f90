...
contains
   ...
   subroutine init_Uelements(Norb,Uelements)
      ...
      if(allocated(Uelements%Full_J))deallocate(Uelements%Full_J)
      ...
      allocate(Uelements%Full_J(Norb*Norb,Norb*Norb))    ;Uelements%Full_J=.false.
         ...
         do jorb=1,Norb
            do korb=1,Norb
               do lorb=1,Norb
                  ...
                  Uelements%Full_J(ib1,ib2) = Uelements%Full_Jsf(ib1,ib2) .or. Uelements%Full_Jph(ib1,ib2)
                  !
